...
<head>
    ...
    <title>Create Account — MonoFit</title>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .bg-glow { position: absolute; top: -120px; left: 50%; transform: translateX(-50%); width: 320px; height: 320px; background: radial-gradient(circle, rgba(255,69,0,0.15) 0%, transparent 70%); pointer-events: none; z-index: 0; }
        ...
        .auth-body { position: relative; z-index: 1; flex: 1; padding: 28px 24px 48px; display: flex; flex-direction: column; }
        ...
        .auth-title { font-size: 30px; font-weight: 800; color: #fff; letter-spacing: -0.7px; line-height: 1.15; margin-bottom: 6px; }
        .auth-sub { font-size: 14px; color: #666; margin-bottom: 28px; line-height: 1.5; }
        .free-badge { display: inline-flex; align-items: center; gap: 6px; background: rgba(16,185,129,0.1); border: 1px solid rgba(16,185,129,0.25); border-radius: 50px; padding: 5px 12px; margin-bottom: 24px; font-size: 12px; font-weight: 600; color: #10b981; }
        .form-group { margin-bottom: 14px; }
        .form-label { font-size: 11px; font-weight: 700; color: #777; display: block; margin-bottom: 7px; letter-spacing: 0.5px; text-transform: uppercase; }
        .form-input { width: 100%; background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.09); border-radius: 13px; padding: 14px 16px; color: #fff; font-size: 15px; font-family: 'Figtree', sans-serif; outline: none; transition: border-color 0.2s, background 0.2s; }
        ...
        .btn-submit { width: 100%; padding: 16px; background: linear-gradient(135deg, #ff4500, #ff6a00); border: none; border-radius: 14px; color: #fff; font-size: 16px; font-weight: 700; font-family: 'Figtree', sans-serif; cursor: pointer; margin-top: 8px; margin-bottom: 24px; letter-spacing: -0.2px; }
        .btn-submit:hover { opacity: 0.92; }
        .terms-note { font-size: 12px; color: #444; text-align: center; line-height: 1.5; margin-bottom: 24px; }
...
<div class="max-phone">
    ...
    <div class="auth-header">
        ...
        <a href="{{ route('login') }}" style="font-size:13px;color:#888;font-weight:500;text-decoration:none;">Already a member?</a>
    </div>
    ...
    <div class="auth-body">
        ...
        <h1 class="auth-title">Start your<br>journey 🚀</h1>
        <p class="auth-sub">Create your free account and start training smarter today.</p>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-input {{ $errors->has('name') ? 'has-error' : '' }}"
        ...
        <div class="divider">
            ...
            <span style="font-size:12px;color:#333;">Already have an account?</span>
            <div class="divider-line"></div>
        </div>

        <div class="auth-footer">
            <a href="{{ route('login') }}" style="display:block;width:100%;padding:15px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.09);border-radius:14px;color:#ccc;font-size:15px;font-weight:600;text-decoration:none;text-align:center;">Log in to your account</a>
        </div>
    </div>
</div>
</body>
